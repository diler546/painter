...
add_action('plugins_loaded', 'mfwp_load_plugin_textdomain'); // load translation
...
class MapsForWP {
 ...
 public static function on_activation() {  	
	if (is_multisite()) {
	 add_blog_option(get_current_blog_id(), 'mfwp_version', '1.2.0');
